  ...
  return (
    <footer className="bg-[#0a0a0a] text-white">
      ...
      <div className="grid md:grid-cols-2">
        ...
        {/* Contact and Social */}
        <div className="bg-[#B8A76B] px-8 md:px-16 py-20 md:py-24 flex flex-col items-center justify-center text-center">
          <p className="text-sm uppercase tracking-widest mb-6 opacity-90 font-light">CONTACTO</p>
          <a
            href="mailto:pcastaneda@remax.com.ar"
            className="text-lg md:text-xl font-light mb-16 hover:opacity-80 transition-opacity underline decoration-1 underline-offset-4"
          >
            contacto@pablocastaneda.com.ar
          </a>

          <p className="text-sm uppercase tracking-widest mb-8 opacity-90 font-light">COMUNIDAD</p>
      ...
      <div className="bg-[#B8A76B] px-8 py-8 text-center border-t border-white/10">
        <p className="text-sm text-white/80 flex items-center justify-center gap-2">
          Desarrollado con <Heart className="w-4 h-4 fill-current" /> por{" "}
          <a
